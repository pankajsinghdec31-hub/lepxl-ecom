...
export default function ROICalculator() {
  ...
  return (
    <div className="relative w-full max-w-4xl mx-auto rounded-3xl bg-[#111111] border border-white/[0.08] p-6 sm:p-8 overflow-hidden">
      {/* Dynamic ambient highlight */}
      <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-[#00AF56]/[0.03] blur-[80px] pointer-events-none" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col justify-between gap-6">
          <div className="flex flex-col gap-2">
            <span className="text-xs text-[#00AF56] font-mono uppercase tracking-widest font-bold flex items-center gap-1.5">
          ...
          <div className="flex flex-col gap-6 pt-4">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-center text-xs">
                ...
                <span className="text-white font-mono font-bold text-sm bg-white/[0.03] border border-white/[0.06] px-2.5 py-1 rounded-lg">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-center text-xs">
                <span className="text-[#8C8C8C] font-semibold">Current Store Conversion Rate</span>
                <span className="text-white font-mono font-bold text-sm bg-white/[0.03] border border-white/[0.06] px-2.5 py-1 rounded-lg flex items-center gap-0.5">
                  {convRate}%
                </span>
              </div>
              <input
        ...
        <div className="lg:col-span-5 flex flex-col justify-between p-6 rounded-2xl bg-[#181818] border border-white/[0.06] relative overflow-hidden">
          <div className="absolute top-0 right-0 w-24 h-24 bg-[#00AF56]/10 rounded-full blur-xl pointer-events-none" />
          
          <div className="flex flex-col gap-4">
            <span className="text-[10px] text-[#8C8C8C] font-mono uppercase tracking-widest">Projection Output</span>
            
            {/* Projected Extra Revenue */}
            <div className="flex flex-col">
              <span className="text-xs text-[#8C8C8C]">Untapped Monthly Revenue</span>
              <span className="text-3xl sm:text-4xl font-extrabold text-[#00AF56] font-mono tracking-tight mt-1">
                +{formatCurrency(extraRevenue)}
              </span>
              <span className="text-[10px] text-white/50 font-semibold mt-1 flex items-center gap-1">
            ...
            <div className="flex flex-col gap-3.5 mt-4 pt-4 border-t border-white/[0.04]">
              {/* Row 1: Conversion Rates */}
              <div className="flex justify-between items-center text-xs">
                <span className="text-[#8C8C8C]">Conversion Target</span>
              ...
              <div className="flex justify-between items-center text-xs">
                <span className="text-[#8C8C8C]">Estimated Orders</span>
                <div className="flex items-center gap-3 font-mono">
              ...
              {/* Row 3: Blended ROAS */}
              <div className="flex justify-between items-center text-xs">
                <span className="text-[#8C8C8C]">Ad Account ROAS</span>
                <div className="flex items-center gap-3 font-mono">
              ...
              {/* Row 4: Total Revenue */}
              <div className="flex justify-between items-center text-xs">
                <span className="text-[#8C8C8C]">Projected Revenue</span>
                <div className="flex items-center gap-3 font-mono">
                  <span className="text-red-400">{formatCurrency(currentRevenue)}</span>
                  <span className="text-[#00AF56] font-bold">{formatCurrency(targetRevenue)}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 pt-4 border-t border-white/[0.04] flex flex-col gap-2">
            <a
              href="/contact"
              className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-xs font-bold uppercase tracking-wider text-black bg-[#00AF56] hover:bg-[#00AF56]/90 transition-all text-center"
            >
