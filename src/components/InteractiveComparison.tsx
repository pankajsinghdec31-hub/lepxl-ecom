  ...
  return (
    <div className="w-full flex flex-col gap-8 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 items-stretch">
        ...
        <div className="p-6 sm:p-8 rounded-3xl bg-gradient-to-b from-red-950/20 via-[#0d0709] to-[#080405] border border-red-500/20 relative overflow-hidden flex flex-col justify-between shadow-2xl group">
          {/* Subtle Ambient Red Glow */}
          <div className="absolute top-0 right-0 w-48 h-48 bg-red-500/[0.04] blur-3xl pointer-events-none" />

          <div>
            {/* Header */}
            <div className="flex items-center justify-between border-b border-red-500/20 pb-5 mb-6">
              ...
              <span className="text-xs font-mono font-bold text-red-400 bg-red-500/10 border border-red-500/20 px-2.5 py-1 rounded-full">
                ~1%–2% Conv.
              </span>
            </div>
            ...
            <div className="space-y-4">
              {COMPARISON_POINTS.map((pt) => (
                <div key={pt.id} className="flex items-start gap-3 p-3 rounded-xl bg-red-950/20 border border-red-500/10">
          ...
          <div className="mt-8 pt-4 border-t border-red-500/10 text-center">
        ...
        <div className="p-6 sm:p-8 rounded-3xl bg-gradient-to-b from-emerald-950/40 via-[#07140f] to-[#040a08] border-2 border-emerald-500/50 relative overflow-hidden flex flex-col justify-between shadow-[0_0_40px_rgba(16,185,129,0.15)] group">
          {/* Subtle Ambient Emerald Glow */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-emerald-500/[0.08] blur-3xl pointer-events-none" />

          <div>
            {/* Header */}
            <div className="flex items-center justify-between border-b border-emerald-500/30 pb-5 mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white font-grotesk flex items-center gap-1.5">
                    <span>SalePXL Shopify Store</span>
                    <Sparkles className="w-4 h-4 text-emerald-400 animate-pulse" />
                  </h3>
                  <span className="text-[10px] text-emerald-400 font-mono font-semibold">Branded Conversion Engine</span>
                </div>
              </div>
              <span className="text-xs font-mono font-bold text-emerald-300 bg-emerald-500/20 border border-emerald-500/40 px-2.5 py-1 rounded-full shadow-[0_0_10px_rgba(16,185,129,0.2)]">
                3.5%–5%+ Conv.
              </span>
            </div>
            ...
            <div className="space-y-4">
              {COMPARISON_POINTS.map((pt) => (
                <div key={pt.id} className="flex items-start gap-3 p-3 rounded-xl bg-emerald-950/40 border border-emerald-500/25 shadow-sm">
      ...
      <div className="p-5 rounded-2xl bg-gradient-to-r from-[#0d1522] via-[#09101a] to-[#0d1522] border border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
          <h4 className="text-sm font-bold text-white font-grotesk">Ready to upgrade from a Basic Store to a Branded SalePXL Engine?</h4>
          <p className="text-xs text-white/60 font-sans mt-0.5">We engineer high-converting Shopify Stores tailored to turn clicks into loyal customers.</p>
        </div>
        <a
          href="/contact"
