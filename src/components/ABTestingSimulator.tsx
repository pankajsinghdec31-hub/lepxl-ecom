  ...
  return (
    <div className="w-full max-w-5xl mx-auto flex flex-col gap-10">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-b border-white/[0.08] pb-6">
        <div>
          <span className="text-xs text-[#00AF56] font-mono uppercase tracking-widest font-bold flex items-center gap-1">
        ...
        {/* Tab Controls */}
        <div className="bg-[#111111] p-1.5 rounded-full border border-white/[0.08] flex gap-2 w-full sm:w-auto">
          <button
            onClick={() => {
              setActiveTab("before");
          ...
          <button
            ...
            className={`flex-1 sm:flex-none px-6 py-2 rounded-full text-xs font-bold uppercase tracking-wider transition-all ${
              activeTab === "after"
                ? "bg-[#00AF56]/20 text-[#00AF56] border border-[#00AF56]/20"
                : "text-[#8C8C8C] hover:text-white"
            }`}
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        ...
        <div className="lg:col-span-7 flex justify-center items-center">
          <div className="relative w-full max-w-sm rounded-[32px] bg-[#111111] border-4 border-white/[0.08] p-4 pt-8 shadow-2xl overflow-hidden aspect-[9/18]">
            ...
            <div className="w-full h-full rounded-2xl bg-[#080808] border border-white/[0.04] p-4 flex flex-col justify-between overflow-y-auto relative no-scrollbar">
              
              {/* Product Header */}
              <div className="flex justify-between items-center pb-2.5 border-b border-white/[0.04] mb-3">
                <span className="text-[10px] text-[#8C8C8C] font-mono tracking-widest">STOREFRONT</span>
                <span className={`text-[10px] font-bold font-mono px-2 py-0.5 rounded ${
                  activeTab === "before" ? "bg-red-500/20 text-red-400" : "bg-[#00AF56]/20 text-[#00AF56]"
                }`}>
              ...
              <div className="flex flex-col gap-4">
                {/* Product Image Panel */}
                <div className="relative aspect-[4/3] rounded-xl bg-gradient-to-tr from-[#111111] to-[#1a1a1a] border border-white/[0.04] flex items-center justify-center overflow-hidden">
                  <Smartphone className={`w-12 h-12 transition-transform duration-500 ${
                    activeTab === "before" ? "text-red-400 rotate-12 scale-90" : "text-[#00AF56] scale-100"
                  }`} />
                  
                  {/* Subtle glass grid on hover */}
                  <div className="absolute inset-0 bg-gradient-to-t from-[#080808]/80 to-transparent" />
                  
                  <span className="absolute bottom-2 left-2 text-[9px] text-[#8C8C8C] bg-[#050505]/60 px-2 py-0.5 rounded backdrop-blur">
                    Mockup Device Case
                  </span>
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                  <div className="flex items-center gap-1">
                    ...
                    {activeTab === "after" && (
                      <span className="text-[9px] text-[#00AF56] font-semibold font-mono bg-[#00AF56]/10 px-1.5 rounded">
                        142 reviews
                      </span>
                    )}
                  </div>
                ...
                {activeTab === "before" ? (
                  <div className="flex flex-col gap-2.5 text-[10px] text-[#8c8c8c] bg-white/[0.01] p-3 rounded-lg border border-white/[0.03]">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <div className="flex gap-2">
                        <span className="text-[9px] border border-[#00AF56] text-[#00AF56] bg-[#00AF56]/5 px-3 py-1 rounded-md font-bold">
                          Black
                        </span>
                        <span className="text-[9px] border border-white/10 text-white/50 px-3 py-1 rounded-md">
                          Tan Brown
                        </span>
                        <span className="text-[9px] border border-white/10 text-white/50 px-3 py-1 rounded-md">
                          Olive Green
                    ...
                    {/* Trust Indicators */}
                    <div className="grid grid-cols-2 gap-2 text-[8px] font-mono text-white/80">
                      <div className="flex items-center gap-1 bg-[#111111] p-1.5 rounded border border-white/[0.03]">
                        <Zap className="w-2.5 h-2.5 text-[#00AF56]" />
                        <span>Ships in 24 hrs</span>
                      </div>
                      <div className="flex items-center gap-1 bg-[#111111] p-1.5 rounded border border-white/[0.03]">
                        <ShieldCheck className="w-2.5 h-2.5 text-[#00AF56]" />
              ...
              <div className="mt-4 pt-3.5 border-t border-white/[0.04] flex flex-col gap-2">
                <button className={`w-full py-2.5 rounded-lg text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 ${
                  activeTab === "before"
                    ...
                    : "bg-[#00AF56] text-black hover:bg-[#00AF56]/90 shadow-[0_0_15px_rgba(0,175,86,0.3)]"
                }`}>
                  {activeTab === "before" ? (
                ...
                {activeTab === "after" && (
                  <p className="text-[8px] text-[#8C8C8C] text-center">
                    ...
                    <button
                      ...
                      className={`absolute w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold transition-all duration-300 z-30 ${
                        hoveredHotspot === spot.id
                          ? "bg-[#00AF56] text-black scale-125"
                          : "bg-white text-black animate-pulse"
                      }`}
                      style={{
                        top: spot.y,
                        left: spot.x,
                        boxShadow: hoveredHotspot === spot.id ? "0 0 15px #00AF56" : "0 0 10px rgba(255,255,255,0.7)"
                      }}
                      title={spot.title}
                    >
                      !
        ...
        <div className="lg:col-span-5 flex flex-col justify-between p-6 sm:p-8 rounded-2xl bg-[#111111] border border-white/[0.08]">
          <div className="flex flex-col gap-6">
            <span className="text-xs text-[#8C8C8C] font-mono uppercase tracking-widest">Auditing Optimization Parameters</span>
            <h4 className="text-lg font-bold text-white">
              {activeTab === "before" ? "Why Cluttered Layouts Fail" : "How Optimization Multiplies Sales"}
            </h4>

            {activeTab === "before" ? (
              <div className="flex flex-col gap-4 text-xs sm:text-sm text-[#8C8C8C] leading-relaxed">
                <p>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="text-xs font-semibold text-white mt-2">
                  👉 Click or hover any pulsing hot-spot (<span className="text-[#00AF56] font-bold">!</span>) on the mobile mockup to view details.
                </div>
              </div>
            )}
            ...
            {activeTab === "after" && (
              <div className="min-h-[140px] mt-4 p-4 rounded-xl bg-[#181818] border border-white/[0.04] transition-all flex flex-col justify-center">
                <AnimatePresence mode="wait">
                  {hoveredHotspot !== null ? (
                    ...
                    >
                      <div className="flex items-center gap-2 text-[#00AF56] font-semibold text-xs uppercase tracking-wider font-mono">
                    ...
                    <motion.div
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      className="text-center py-4 text-xs text-[#8C8C8C] flex flex-col items-center gap-2"
                    >
          ...
          <div className="mt-8 pt-4 border-t border-white/[0.04] flex flex-col gap-2">
            <div className="flex justify-between items-center text-xs font-mono">
              <span className="text-[#8C8C8C]">Optimization Focus:</span>
