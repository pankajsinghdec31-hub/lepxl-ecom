        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch mt-8">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 justify-between">
            <div className="flex flex-col gap-6">
              ...
              <div className="p-6 rounded-2xl glass-card flex items-start gap-4 shadow-sm">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-[#8e8e93] mt-1">Himalayan Innovation Hub</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl glass-card flex flex-col gap-4 shadow-sm">
              ...
              <div className="p-3 rounded-lg bg-white/[0.01] border border-white/[0.05] text-[10px] font-mono text-[#8e8e93] flex justify-between items-center">
          ...
          <div className="lg:col-span-7 p-8 rounded-3xl glass-card relative overflow-hidden flex flex-col justify-center shadow-sm">
            <AnimatePresence mode="wait">
              {!submitted ? (
                ...
                >
                  ...
                  <div className="p-4 rounded-xl bg-primary/10 border border-primary/20 text-xs leading-relaxed flex gap-3 text-[#8e8e93]">
                    <ShieldCheck className="w-5 h-5 text-primary shrink-0 mt-0.5" />
                    <div>
                      <strong className="font-semibold text-white block mb-0.5">High-Performance Guarantee:</strong>
                      We design & build <span className="text-primary font-bold">only high-performing Shopify stores</span> with speed-accelerated, conversion-focused product pages that are mathematically optimized to increase your ROAS.
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label className="text-[10px] text-[#8e8e93] uppercase tracking-wider font-semibold">Brand / Shop Name</label>
                      <input
                        type="text"
                        required
                        ...
                        className="bg-white/[0.02] border border-white/[0.1] text-white text-xs rounded-xl px-4 py-3 focus:outline-none focus:border-primary transition-colors"
                      />
                    </div>

                    {/* Contact Name */}
                    <div className="flex flex-col gap-1.5">
                      <label className="text-[10px] text-[#8e8e93] uppercase tracking-wider font-semibold">Your Name</label>
                      <input
                        type="text"
                        required
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {/* Phone Number */}
                    <div className="flex flex-col gap-1.5">
                      <label className="text-[10px] text-[#8e8e93] uppercase tracking-wider font-semibold">Phone Number (WhatsApp)</label>
                      <input
                        type="text"
                        required
                    ...
                    {/* Email */}
                    <div className="flex flex-col gap-1.5">
                      <label className="text-[10px] text-[#8e8e93] uppercase tracking-wider font-semibold">Email Address</label>
                      <input
                        type="email"
                        required
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-[10px] text-[#8e8e93] uppercase tracking-wider font-semibold">Project Category</label>
                      ...
                      <button
                        ...
                        className={`p-4 rounded-xl border text-left flex flex-col gap-2.5 transition-all relative overflow-hidden cursor-pointer ${
                          formData.projectCategory === "new-store"
                            ...
                            : "bg-white/[0.01] border-white/[0.1] text-[#8e8e93] hover:border-white/20 hover:text-white"
                        }`}
                      >
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label className="text-[10px] text-[#8e8e93] uppercase tracking-wider font-semibold">Shopify Monthly Revenue</label>
                      <select
                        required
                        value={formData.revenueBracket}
                        onChange={(e) => setFormData({ ...formData, revenueBracket: e.target.value })}
                        className="bg-[#121214] border border-white/[0.1] text-white text-xs rounded-xl px-4 py-3 focus:outline-none focus:border-primary transition-colors appearance-none cursor-pointer"
                      >
                        <option value="" className="bg-[#121214]">Select Range</option>
                        <option value="under-1" className="bg-[#121214]">Under ₹1 Lakh</option>
                        <option value="1-5" className="bg-[#121214]">₹1 Lakh - ₹5 Lakhs</option>
                        <option value="5-15" className="bg-[#121214]">₹5 Lakhs - ₹15 Lakhs</option>
                        <option value="15-plus" className="bg-[#121214]">₹15 Lakhs+ / Month</option>
                      </select>
                    </div>
                  </div>
                  ...
                  {/* Message Detail */}
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[10px] text-[#8e8e93] uppercase tracking-wider font-semibold">Tell us about your product or growth targets</label>
                    <textarea
                      rows={3}
                      placeholder="e.g. We want to scale our conversion rate and prepare a brand-new storefront launch..."
                      value={formData.message}
                      onChange={(e) => setFormData({ ...formData, message: e.target.value })}
                      className="bg-white/[0.02] border border-white/[0.1] text-white text-xs rounded-xl px-4 py-3 focus:outline-none focus:border-primary transition-colors resize-none"
                    />
                  </div>
                ...
                >
                  <span className="w-14 h-14 rounded-full bg-primary/15 border border-primary/30 text-primary flex items-center justify-center shrink-0 shadow-[0_8px_24px_rgba(16,185,129,0.15)] animate-bounce">
                    <Check className="w-6 h-6" />
                  </span>
                  <div className="flex flex-col gap-2">
                    <h3 className="text-xl font-bold text-white">Strategy Request Queued</h3>
                    <p className="text-xs text-[#8e8e93] max-w-sm mx-auto leading-relaxed text-center">
                      Thank you for submitting, <span className="text-white font-semibold">{formData.name}</span>. We will analyze <span className="text-white font-semibold">{formData.brandName}</span>'s parameters for a <span className="text-primary font-bold">
                  ...
                  <button
                    onClick={handleReset}
                    className="mt-4 px-5 py-2.5 rounded-xl border border-white/[0.08] text-[10px] font-bold text-[#8e8e93] uppercase tracking-wider hover:bg-white/[0.02] transition-all bg-white/5"
                  >
