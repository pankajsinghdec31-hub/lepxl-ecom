  ...
  return (
    <div className="relative py-16 px-6">
      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-16">
        ...
        <div className="rounded-3xl bg-[#0d0d0f]/80 border border-white/[0.06] p-8 md:p-12 flex flex-col gap-12 relative overflow-hidden">
          {/* Subtle glow edge */}
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-white/[0.05] pb-8 relative z-10">
            ...
            <div className="px-5 py-2.5 rounded-2xl bg-[#0b0b0c] border border-[#00AF56]/30 flex items-center gap-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 relative z-10">
            <div className="p-6 rounded-2xl bg-[#0b0b0c] border border-white/[0.05] flex flex-col gap-2">
              <span className="text-xs text-[#8C8C8C] font-mono uppercase tracking-wider">Mobile Page Speed</span>
              <span className="text-3xl font-extrabold text-white font-mono">1.9 Seconds</span>
              <span className="text-[10px] text-[#8C8C8C] mt-1">Improved from 6.8s load times</span>
            </div>

            <div className="p-6 rounded-2xl bg-[#0b0b0c] border border-white/[0.05] flex flex-col gap-2">
              <span className="text-xs text-[#8C8C8C] font-mono uppercase tracking-wider">Conversion Rate</span>
              <span className="text-3xl font-extrabold text-[#00AF56] font-mono">4.2%</span>
              <span className="text-[10px] text-[#00AF56] font-medium mt-1">+281% Net conversion lift</span>
            </div>

            <div className="p-6 rounded-2xl bg-[#0b0b0c] border border-white/[0.05] flex flex-col gap-2">
              <span className="text-xs text-[#8C8C8C] font-mono uppercase tracking-wider">Revenue Growth</span>
              <span className="text-3xl font-extrabold text-white font-mono">+410%</span>
              <span className="text-[10px] text-[#8C8C8C] mt-1">Net sales scale in 90 days</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10 pt-4">
            ...
            <div className="lg:col-span-5 p-6 rounded-2xl bg-[#0b0b0c] border border-white/[0.05] flex flex-col justify-between gap-6">
              <div>
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="h-2 w-full bg-white/[0.05] rounded-full overflow-hidden mt-1">
                      <div className="h-full bg-[#00AF56] rounded-full" style={{ width: "97%" }} />
                    </div>
        ...
        <div className="p-8 md:p-12 rounded-3xl bg-[#0d0d0f]/80 border border-white/[0.06] text-center flex flex-col gap-6 items-center">
