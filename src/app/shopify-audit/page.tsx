...
export default function ShopifyAuditPage() {
  ...
  return (
    <div className="relative min-h-screen bg-bg-dark text-white pb-24 overflow-hidden text-left">
      ...
      <div className="absolute bottom-[10%] left-[-5%] w-[40%] h-[500px] rounded-full bg-primary/[0.02] blur-[130px] pointer-events-none" />
              ...
              {!formSubmitted ? (
                ...
                <div className="flex flex-col items-center text-center p-6 gap-4">
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-4 mt-6 w-full">
                    ...
                    <Link
                      href="/contact"
                      className="w-full sm:flex-1 py-3 px-4 rounded-xl text-xs font-bold uppercase tracking-wider text-white bg-primary text-center hover:bg-[#2a6350]"
                    >
                      Book 1-on-1 Call
                    </Link>
                  </div>
